...
class ApiService:
    ...
    def listar(self, tabla, limite=None):
        ...
        try:
            ...
            # ─── Paso 4: Verificar status code ────────────────
            # Si la API retorna 204 (No Content), no hay datos ni body JSON.
            # Intentar hacer .json() en una respuesta 204 lanzaría error.
    ...
    # ═══════════════════════════════════════════════════════════
    def obtener(self, tabla, nombre_clave, valor_clave):
        """
        ...
        ───────────
        tabla        (str): Nombre de la tabla. Ejemplo: "producto"
        nombre_clave (str): Nombre de la columna clave. Ejemplo: "codigo"
        ...
        ¿Cómo funciona?
        ────────────────
        1. Arma la URL: http://localhost:8000/api/producto/codigo/PR001
        2. Hace GET a esa URL
        3. La API responde con: {"datos": [{"codigo": "PR001", ...}]}
        4. Extrae el primer (y único) elemento de "datos"
        """
        url = f"{self.base_url}/{tabla}/{nombre_clave}/{valor_clave}"
