...
def index():
    ...
    if accion == "editar" and clave:
        producto_editar = api.obtener("producto", "codigo", clave)
        # Llama a la API: GET http://localhost:8000/api/producto/codigo/PR001
...
def actualizar():
    ...
    # ─── Enviar a la API ──────────────────────────────────────
    exito, mensaje = api.actualizar("producto", "codigo", codigo, datos)
    # api.actualizar() usa PUT en vez de POST.
    # El "codigo" va en la URL: PUT /api/producto/codigo/PR001
...
def eliminar():
    ...
    # ─── Enviar a la API ──────────────────────────────────────
    exito, mensaje = api.eliminar("producto", "codigo", codigo)
    # api.eliminar() usa DELETE: DELETE /api/producto/codigo/PR001
